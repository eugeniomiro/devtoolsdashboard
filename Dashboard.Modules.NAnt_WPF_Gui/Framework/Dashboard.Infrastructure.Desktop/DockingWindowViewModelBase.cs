...
namespace Techno_Fly.Tools.Dashboard 
{
	...
	public abstract class DockingWindowViewModelBase<T> : ViewModelBase, IDockingWindowViewModel where T: DockableContent {

        protected DockingWindowViewModelBase() { }

		protected DockingWindowViewModelBase(IUnityContainer container, IRegionManager regionManager, IEventAggregator eventAggregator ) : base(container, regionManager, eventAggregator ) {}
